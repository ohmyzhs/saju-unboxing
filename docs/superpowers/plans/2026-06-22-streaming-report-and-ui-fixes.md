...
- [x] **Step 1: Write failing plan prompt tests**
...
- [x] **Step 3: Implement the compact plan request**
...
- [x] **Step 4: Write failing transport retry tests**
...
- [x] **Step 5: Run transport tests and confirm RED**

Run: `node --test test/ai-transport.test.js`

Expected: 503/제한 시간 재시도와 504 변환이 없어 실패.

- [x] **Step 6: Implement timeout, output limits, and bounded retry**
...
- [x] **Step 1: Write failing SSE helper and pipeline tests**
...
- [x] **Step 3: Implement SSE helpers and report pipeline**
...
- [x] **Step 4: Connect stream mode without breaking JSON mode**
...
- [x] **Step 5: Run stream and existing API tests**
...
- [x] **Step 1: Write failing chunked SSE parser tests**
...
- [x] **Step 3: Implement the parser and progress helpers**
...
- [x] **Step 4: Replace fake progress with streamed business events**
...
- [x] **Step 5: Make loading copy truthful and include script in checks**
...
- [x] **Step 6: Run client stream tests and confirm GREEN**
...
- [x] **Step 1: Write failing pillar normalization tests**
...
- [x] **Step 2: Run daily UI tests and confirm RED**

Run: `node --test test/daily-fortune-ui.test.js`

Expected: 정규화 모듈과 grid 스타일이 없어 실패.

- [x] **Step 3: Implement normalizer and render adapter**
...
- [x] **Step 4: Replace absolute hero layout with responsive grid**

헤드라인과 점수를 `minmax(0, 1fr) auto` 두 열로 배치하고 상단 메타와 태그는 전체 열을 차지하게 한다. 420px 이하에서는 점수를 다음 줄로 보내 텍스트 폭을 보장한다.

- [x] **Step 5: Run daily UI tests and confirm GREEN**
...
- [x] **Step 1: Write failing full-use calculation tests**
...
- [x] **Step 2: Run point UI tests and confirm RED**

Run: `node --test test/point-ui.test.js`

Expected: 순수 계산 모듈과 전액사용 버튼이 없어 실패.

- [x] **Step 3: Implement full-use control**
...
- [x] **Step 4: Run point UI tests and confirm GREEN**
...
- [x] **Step 5: Run local browser verification**
...
- [x] **Step 6: Review requirements and commit**
